...
COMMENT ON TABLE BOARD_REPLY IS '게시판 댓글';
COMMENT ON COLUMN BOARD_REPLY.UPPER_ID IS '상위 댓글 ID';
COMMENT ON COLUMN BOARD_REPLY.BOARD_ID IS '게시물 ID';
COMMENT ON COLUMN BOARD_REPLY.AU_NAME IS '작성자 이름';
COMMENT ON COLUMN BOARD_REPLY.AU_EMAIL IS '작성자 이메일';
COMMENT ON COLUMN BOARD_REPLY.AU_PWD IS '작성자 비밀번호';
COMMENT ON COLUMN BOARD_REPLY.SECRET IS '비밀글';
