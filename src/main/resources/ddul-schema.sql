...
DROP TABLE IF EXISTS MAP_AUTHORITY_USER CASCADE;
CREATE TABLE IF NOT EXISTS MAP_AUTHORITY_USER
(
    ID           BIGINT PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS MAP_AUTHORITY_TEAM
(
    ID           BIGINT PRIMARY KEY,
    AUTHORITY_ID BIGINT NOT NULL,
...
DROP TABLE IF EXISTS MAP_AUTHORITY_MENU CASCADE;
CREATE TABLE IF NOT EXISTS MAP_AUTHORITY_MENU
(
    ID           BIGINT PRIMARY KEY,
    AUTHORITY_ID BIGINT NOT NULL,
...
INSERT INTO MAP_AUTHORITY_MENU (ID, AUTHORITY_ID, MENU_ID) SELECT * FROM (
SELECT -1 AS A, -1 AS B, -2 AS C FROM DUAL UNION ALL
SELECT -2 AS A, -2 AS B, -2 AS C FROM DUAL UNION ALL
SELECT -3 AS A, -3 AS B, -2 AS C FROM DUAL
) WHERE NOT EXISTS( SELECT * FROM MAP_AUTHORITY_MENU );
