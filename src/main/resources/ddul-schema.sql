...
INSERT INTO USER (ID, USERNAME, PASSWORD, EMAIL, NAME, PASSWORD_EXP) SELECT * FROM (
...
COMMENT ON COLUMN CODE.COD_NAME IS '코드 이름';
COMMENT ON COLUMN CODE.ORD IS '순서';
COMMENT ON COLUMN CODE.DSC IS '설명';

INSERT INTO CODE (ID, GRP_COD, COD, COD_NAME, ORD, DSC) SELECT * FROM (
