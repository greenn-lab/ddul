...
COMMENT ON COLUMN USR.PASSWORD_EXP IS '비밀번호 만료일시';
...
INSERT INTO USR (ID, USERNAME, PASSWORD, EMAIL, NAME, PASSWORD_EXP) SELECT * FROM (
...
(
    ID       NUMBER(19) PRIMARY KEY,
    GRP_COD  VARCHAR2(256) NOT NULL,
    COD      VARCHAR2(256) NOT NULL,
    COD_NAME VARCHAR2(256),
    ORD      NUMBER(10)       DEFAULT 0,
    DSC      VARCHAR2(512),
    USE      CHAR(1)   DEFAULT 'Y' CHECK (USE = 'Y' OR USE = 'N'),
    -- auditors
