...
import static io.github.greennlab.ddul.infrastructure.code.dto.CommonCodeDTO.mapped;
...
import io.github.greennlab.ddul.infrastructure.code.repository.DDulCodeRepository;
...
public class CodeServiceImpl implements CodeService {
  ...
  public List<CommonCodeDTO> searchBy(String group, String name) {
    final List<CommonCode> codes = ObjectUtils.isEmpty(name)
